...
const Landing: React.FC = () => {
    ...
    const feedbacksArray = [
        ...
        },
        {
            ...
            src: JoyAvatar,
            feedback:
                'I have tried other money-tracking apps before Atticus, but I choose to stick to this because of its simplicity and intuitive design.',
        },
        {
            name: 'Sophia',
            src: EmmaAvatar,
        ...
        <>
            <div className={styles.wrapper}>
                <HighlightBanner
                    ...
                    details={
                        'Use Atticus to plan your budget and take control of finances'
                    }
                />
