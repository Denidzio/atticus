...
This is the repository responsible for Atticus's apps.

## 🏭 Applications

-   [Backend](./backend) — Atticus's application backend.

    _To work properly, fill in the **`.env`** file. Use the **`.env.example`** file as an example._

-   [Frontend](./frontend) — Atticus's application frontend.

    _To work properly, fill in the **`.env`** file. Use the **`.env.example`** file as an example._

-   [Shared](./shared) — Atticus's application common modules for reuse.
